...
export default function Funding() {
  ...
  if (storage.getFundingRequests().length === 0) {
    ...
    if (demoUser) {
      storage.addFundingRequest({
        ...
        description:
          "Help me prepare for the upcoming Olympic trials. Funds will be used for specialized training equipment and coaching.",
        amount: 5000,
      ...
      storage.addFundingRequest({
        ...
        description:
          "Support my journey to the national championships. Covering travel, accommodation, and entry fees.",
        amount: 2500,
      ...
      storage.addFundingRequest({
        ...
        description:
          "Need to upgrade my training equipment to stay competitive at the international level.",
        amount: 1500,
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      {/* Left Sidebar */}
      <div className="lg:w-auto w-full px-4 py-6 border-none">
